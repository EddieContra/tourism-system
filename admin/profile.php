                            ...
                            <div class="col-md-4 border-right">
                              <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                               ...
                               if($row->Photo=="avatar15.jpg"){ ?>
                                ...
                                <?php 
                              } ?><span class="font-weight-bold"><?php  echo $row->FirstName;?> <?php  echo $row->LastName;?></span><span class="text-black-50"><?php  echo $row->Email;?></span><span>+255&nbsp;<?php  echo $row->MobileNumber;?></span>
                              <div class="mt-3">
